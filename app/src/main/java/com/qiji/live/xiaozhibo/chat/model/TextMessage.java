...
import com.qiji.live.xiaozhibo.utils.EmoticonUtil;
...
public class TextMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        TextView tv = new TextView(TCApplication.context());
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        tv.setTextColor(TCApplication.context().getResources().getColor(isSelf() ? R.color.white : R.color.black));

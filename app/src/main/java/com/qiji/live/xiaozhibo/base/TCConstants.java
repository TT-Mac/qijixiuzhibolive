...
public class TCConstants {
	...
	*/
    //云通信服务相关配置
    public static final int IMSDK_ACCOUNT_TYPE = 6098;
    public static final int IMSDK_APPID = 1400011739;

    //COS存储服务相关配置
    public static final String COS_BUCKET = "yunbao";
    public static final String COS_APPID  = "1252873276";

    //业务Server的Http配置
    public static final String SVR_POST_URL = "http://www.suanzhi919.com";

    //微信AppId
    public static final String WECHAT_ID = "wx760c6f0f98601c31";
	...
	*/
    ...
    public static final int PRAISE              = 3;//点赞
    public static final int GIFT                = 4;//礼物
	...
	*/
    ...
    public static final int IMCMD_SHUT_UP       = 7;   // 禁言消息
    public static final int IMCMD_SET_MANAGE       = 9;   // 设置管理员消息
    public static final int IMCMD_SET_MANAGE_CANCEL       = 10;   // 取消管理员消息
    public static final int IMCMD_NOTIFY         = 11;  //通知
    //ERROR CODE TYPE

...
public abstract class Message {
    ...
    public RelativeLayout getBubbleView(ChatAdapter.ViewHolder viewHolder){
        ...
        if (message.isSelf()){
            ...
            TCUtils.showPicWithUrl(TCApplication.getInstance(),viewHolder.rightAvatar, UserInfoMgr.getInstance().getHeadPic(), R.drawable.bg);
            return viewHolder.rightMessage;
        }else{
            TCUtils.showPicWithUrl(TCApplication.getInstance(),viewHolder.leftAvatar, avatar, R.drawable.bg);

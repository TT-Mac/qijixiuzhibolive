...
public class NewsLiveListMgr {
    ...
    private NewsLiveListMgr() {
        mIsFetching = false;
    }

    private static class NewsMgrHolder {
        private static NewsLiveListMgr instance = new NewsLiveListMgr();
    }

    public static NewsLiveListMgr getInstance() {
        return NewsMgrHolder.instance;
    }
    ...
    public void fetchLiveList(final int type, final int pageNo, final int pageSize, final TCLiveListMgr.Listener listener) {
        ...
        Call<ResponseJson<LiveBean>> call = apiStores.requestNews(TCApplication.getInstance().getLoginUid());

...
public class TCActivityTitle extends RelativeLayout {
    ...
    public TCActivityTitle(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            tvBackImg = ta.getResourceId(R.styleable.TCActivityTitle_titleBackImg,R.drawable.btn_return);
            textColor = ta.getColor(R.styleable.TCActivityTitle_titleColor,context.getResources().getColor(R.color.light_gray));
            setUpView(context);
        } finally {
            ta.recycle();
        }

    ...
    public TCInputTextMsgDialog(Context context, int theme) {
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(msg)) {
                    ...
                    Toast.makeText(mContext, "发送内容为空!", Toast.LENGTH_LONG).show();
                }
        ...
        barrageBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mDanmuOpen) {
                    messageTextView.setHint(R.string.dialog_input_danmu);
...
//                            messageTextView.setText("");
       ...
       /* //发送状态改变事件,弹起
        Event.InputDialogStatusChange dialogStatusChange = new Event.InputDialogStatusChange();
        dialogStatusChange.status = 1;
        dialogStatusChange.y = (int) rlDlg.getY();
        EventBus.getDefault().post(dialogStatusChange);*/
    }

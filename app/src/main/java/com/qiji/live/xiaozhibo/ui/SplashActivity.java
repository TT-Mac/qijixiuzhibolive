 ...
 */
public class SplashActivity extends Activity /*implements TCLoginMgr.TCLoginCallback*/ {
...
//    }
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (activity != null) {
                if (!TCApplication.getInstance().isLogin()) {
                    activity.jumpToLoginActivity();
                } else {
                    Intent intent = new Intent(activity, TCMainActivity.class);
